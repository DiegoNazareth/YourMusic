                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.php">LYRICS</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">SONG  </a>
                                    <a class="nav-link" href="layout-sidenav-light.html">VIDEO</a>
                                </nav>
                            </div>
