                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Tus videos favoritas</a></li>
                        ...
                        $repetida=$_SESSION['videolink'];

                        $sql="SELECT usuario, link FROM videofav WHERE  link='$repetida'  ";
