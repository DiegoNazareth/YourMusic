            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Link de tus videos favoritos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="favideo.php">Tus videos favoritas</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <form method="post"> 
                                        <?php include('errors.php')?>
                                            <div class="form-group">
                                                <label class="small mb-1" >Link</label>
                                                <input class="form-control py-4"  type="text" name="video" placeholder="Ingresa el link de tu video favorito" />
                                            </div>
                                            
                                           
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                               
                                                <input type="submit" name="submit" class="btn btn-primary" value="Video favorito" />
                                                
                                            </div>
                                        </form>
                                        <br/>
                            <strong>Link de tus videos favoritos solo copia y pega en la barra el link <br/></br> </strong>

                            <?php


                               //recuperar videos de la basw de datos 

                               $usuario=$_SESSION['username'];
                               $sql="SELECT link FROM videofav WHERE usuario='$usuario'";
                            ...
                            if(isset($_POST['video'])){
                                $text=$_POST['video'];
                                $text1=$_POST['video'];
                                $_SESSION['videolink']=$text;
                                
                                $usuario=$_SESSION['username'];
                               // echo "video link: ".$text."<br/>";
                                ////se inserta link del video 
                              
                                $text=preg_replace("#.*youtube\.com/watch\?v=#", "", $text);
                               // echo "text video Id : ".$text;
                                

                                 $text= '  <iframe width="424" height="238" src="https://www.youtube.com/embed/'.$text.'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                        echo $text;
                                    echo "<br/>";
                                        //se inserta video 
