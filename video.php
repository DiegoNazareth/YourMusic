            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Agrega tus Videos Musicales Favoritos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Tus videos Favoritos</a></li>
                            ...
                            <form method="post"> 
                                        <?php include('errors.php')?>
                                            <div class="form-group">
                                                <label class="small mb-1" >Link del Video </label>
                                                <input class="form-control py-4"  type="text" id="video" name="video" placeholder="Ingresa el url del video" />
                                             </div>
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                               
                                                <input type="submit" name="submit" class="btn btn-primary" value="Buscar y Agrega a Favoritos" />
                                            </div>
                                        </form>
                        ...
                        <?php
                            if(isset($_POST['video'])){
                                ...
                                $sql="INSERT INTO videofav(link, usuario) VALUES ('$text', '$usuario')";
                                        mysqli_query($db, $sql);
