            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Letras Favoritas</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <strong>Selecciona el link y ponlo en el buscador para mostrar la cancion <br/><br/><br/> </strong>
                                <form method="post"> 
                                        <?php include('errors.php')?>
                                            <div class="form-group">
                                                <label class="small mb-1" >Link</label>
                                                <input class="form-control py-4"  type="text" name="link" placeholder="Ingresa el link de tu letra favorita" />
                                            </div>
                                            
                                           
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                               
                                                <input type="submit" name="enviar" class="btn btn-primary" value="Letra favorita" />
                                            </div>
                                        </form>
                                        <br/>
                                        <br/>
                            <?php
                           // echo "Selecciona el link y ponlo en el buscador para mostrar la cancion <br/>";
                           if(isset ($_POST['enviar'])){
                            ...
                            $json=file_get_contents($link);
                             ...
                             echo "Letra de la cancion ". $data['lyrics']."</br></br></br>";
                           }
                            $usuario=$_SESSION['username'];
                            $sql="SELECT songautor, link FROM letrafav WHERE usuario='$usuario'";
                        ...
                        //pendientre a lo mejor queda aqui
                            //mostrar usuarios que escuchan la misma musica
